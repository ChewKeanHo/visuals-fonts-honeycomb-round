# Honeycomb Round Font | (Holloway) Chew, Kean Ho's Creative Visuals
...
```
Title: Honeycomb Round Font
Creators: Katrina Sutton
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-honeycomb-round
UUID: 53F9D7C1-0C95-4DEC-91A4-D756DD6AD487
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-honeycomb-round
```
